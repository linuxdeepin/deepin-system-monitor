...
// kernel log level
#define TR_TEXT_EMERGENCY   QT_TRANSLATE_NOOP(TR_CONTEXT, "Emergency")
#define TR_TEXT_ALERT       QT_TRANSLATE_NOOP(TR_CONTEXT, "Alert")
#define TR_TEXT_CRITICAL    QT_TRANSLATE_NOOP(TR_CONTEXT, "Critical")
#define TR_TEXT_ERROR       QT_TRANSLATE_NOOP(TR_CONTEXT, "Error")
#define TR_TEXT_WARNING     QT_TRANSLATE_NOOP(TR_CONTEXT, "Warning")
#define TR_TEXT_NOTICE      QT_TRANSLATE_NOOP(TR_CONTEXT, "Notice")
#define TR_TEXT_INFO        QT_TRANSLATE_NOOP(TR_CONTEXT, "Info")
#define TR_TEXT_DEBUG       QT_TRANSLATE_NOOP(TR_CONTEXT, "Debug")

// clear cache depth
#define TR_TEXT_NO_CLEAR            QT_TRANSLATE_NOOP(TR_CONTEXT, "Do not clear")
#define TR_TEXT_CLEAR_PAGE_CACHE    QT_TRANSLATE_NOOP(TR_CONTEXT, "Clear page cache")
#define TR_TEXT_CLEAR_INODES        QT_TRANSLATE_NOOP(TR_CONTEXT, "Clear dentries and inodes")
#define TR_TEXT_CLEAR_ALL           QT_TRANSLATE_NOOP(TR_CONTEXT, "Clear all caches")
