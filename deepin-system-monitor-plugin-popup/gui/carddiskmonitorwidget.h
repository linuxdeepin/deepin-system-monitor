...
*/
#ifndef CARDDISKMONITORWIDGET_H
#define CARDDISKMONITORWIDGET_H
...
class CardDiskMonitorWidget : public QWidget
{
    Q_OBJECT

public:
    explicit CardDiskMonitorWidget(QWidget *parent = nullptr);
    ~CardDiskMonitorWidget();
