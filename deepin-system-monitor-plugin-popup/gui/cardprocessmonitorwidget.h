...
*/
#ifndef CARDPROCESSMONITORWIDGET_H
#define CARDPROCESSMONITORWIDGET_H
...
class CardProcessMonitorWidget : public QWidget
{
    Q_OBJECT

public:
    explicit CardProcessMonitorWidget(QWidget *parent = nullptr);
    ~CardProcessMonitorWidget();
...
#endif // CARDPROCESSMONITORWIDGET_H
