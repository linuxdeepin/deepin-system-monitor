#include "cardnetmonitorwidget.h"
...
CardNetMonitorWidget::CardNetMonitorWidget(QWidget *parent)
    : QWidget(parent)
{
    auto *dAppHelper = DApplicationHelper::instance();
    connect(dAppHelper, &DApplicationHelper::themeTypeChanged, this, &CardNetMonitorWidget::changeTheme);
...
//            this, &CompactCpuMonitor::updateStatus);
    ...
    connect(dynamic_cast<QGuiApplication *>(DApplication::instance()), &DApplication::fontChanged,
            this, &CardNetMonitorWidget::changeFont);

}
CardNetMonitorWidget::~CardNetMonitorWidget() {}


void CardNetMonitorWidget::updateStatus(qreal cpuPercent, const QList<qreal> cPercents)
{
...
void CardNetMonitorWidget::changeTheme(DApplicationHelper::ColorType themeType)
{
    switch (themeType) {
...
void CardNetMonitorWidget::paintEvent(QPaintEvent *e)
{
    setFixedWidth(280);
    QPainter painter;
    painter.begin(this);
...
void CardNetMonitorWidget::changeFont(const QFont &font)
{
    m_sectionFont = font;
