...
1. 在系統監視器介面，單擊左側 **詳細訊息**，右側預設展開處理器的詳細訊息。
...
>![notes](../common/tips.svg) 竅門：您也可以在桌面上查看電腦的硬體狀態，具體操作步驟如下：
>1. 右鍵單擊桌面任務欄，在 **附加元件** 子選單中勾選 **系統監視器**，系統附加元件區會顯示圖示 ![icon](../common/system_monitor.png)。
>
>2. 單擊附加元件區圖示 ![icon](../common/system_monitor.png)，桌面上會展示電腦的處理器、網路、記憶體、磁碟和進程狀態。
>
