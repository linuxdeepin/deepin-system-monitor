...
1. 在系统监视器界面上，单击左侧 **详细信息**，右侧默认展开处理器的详细信息。

![1|monitor](fig/viewdetail.png)

2. 单击处理器旁边的按钮 ![down](../common/nextdown.svg) 展开下拉菜单选项，可以选择查看内存、网络或磁盘的详细信息。

![1|monitor](fig/detail.png)

3. 单击右侧 **隐藏详情** 收起详情页。

>![notes](../common/tips.svg)窍门：您也可以在桌面上查看电脑的硬件状态，具体操作步骤如下：
>1. 右键单击桌面任务栏，在 **插件** 子菜单中勾选 **系统监视器**，系统插件区会显示图标 ![icon](../common/system_monitor.png)。
>2. 单击插件区图标![icon](../common/system_monitor.png)，桌面上会展示电脑的处理器、网络、内存、磁盘和进程状态。
>3. 双击各个监视区域，打开应用并显示对应项的详细信息。
