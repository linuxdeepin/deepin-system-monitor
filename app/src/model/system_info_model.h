...
public:
    ...
    inline bool splashModeEnabled() const
    {
        return m_splashModeEnabled;
    }
    inline void setSplashModeEnabled(bool enabled)
    {
        if (enabled != m_splashModeEnabled) {
            m_splashModeEnabled = enabled;
            Q_EMIT splashModeEnabledChanged(enabled);
        }
    }
...
Q_SIGNALS:
    ...
    void splashModeEnabledChanged(bool);
