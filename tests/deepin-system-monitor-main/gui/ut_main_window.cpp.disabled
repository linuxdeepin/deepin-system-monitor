...
public:
    ...
    {
        if (m_tester) {
            // Use hide + deleteLater instead of direct delete to avoid
            // signal callbacks to partially-destructed child widgets
            m_tester->hide();
...
{
    // MainWindow creates ProcessPageWidget with DBus connections;
    // skip detailed testing under offscreen/limited env.
}
